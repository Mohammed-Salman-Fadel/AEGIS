...
import { installedModelsLabel, modelDownloadPercent, modelReadyMessage, modelSearchPlaceholder, } from '../src/lib/modelDownload.js';
...
test('model search placeholder follows the active provider', () => {
    assert.equal(modelSearchPlaceholder('lmstudio'), 'Enter an LM Studio catalog ID or Hugging Face URL');
