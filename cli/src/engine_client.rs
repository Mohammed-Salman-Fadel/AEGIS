...
impl EngineClient {
                ...
                let note = response
                    ...
                    .map(|value| {
                        ...
                        let rag = value
                            ...
                            .unwrap_or("unknown");
                        format!(
                            "Engine /health responded successfully. provider={provider}, model={model}, sessions={sessions}, rag={rag}."
                        )
                    })
                    .unwrap_or_else(|| "Engine /health responded successfully.".to_string());
    ...
    pub fn list_models(&self) -> AppResult<Vec<ModelSummary>> {
        ...
        Ok(vec![
            ModelSummary {
                name: crate::runtime::DEFAULT_MODEL.to_string(),
